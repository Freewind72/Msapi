...
<div class="card" style="border-left:3px solid #e74c3c">
  <span style="font-weight:600;color:#e74c3c">账户未激活，请前往<a href="?action=shop" style="color:#3498db">商店</a>购买</span>
</div>
<?php endif; ?>
...
<div class="card">
  ...
  <form method="post" action="?action=profile"><input type="hidden" name="_csrf" value="<?= csrf_token() ?>">
    ...
    <div class="form-group">
      ...
      <input class="form-input" type="password" name="password" placeholder="不填则不修改">
    </div>
    <div class="form-group">
    ...
    <div class="theme-toggle-row" style="display:flex;align-items:center;justify-content:space-between;padding:0 0 12px 0">
